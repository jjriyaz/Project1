...
emp_name.click()
emp_name.send_keys("Testing Name_edited")
time.sleep(3)
...
delete = driver.find_element(By.XPATH, "/html/body/div/div[1]/div[2]/div[2]/div/div[2]/div[3]/div/div[2]/div/div/div[9]/div/button[1]")
delete.click()